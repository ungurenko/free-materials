...
const sectionMeta: Record<string, { title: string; description: string }> = {
  vizitki: {
    title: "Визитка эксперта",
    description: "Сильная личная страница с оффером, услугами и одним CTA.",
  },
  lendingi: {
    title: "Лендинг услуги",
    description: "Продающая страница под один оффер: от боли до кнопки.",
  },
  instrumenty: {
    title: "Инструмент",
    description: "Рабочий мини-инструмент: считает, отмечает, даёт итог.",
  },
  igry: {
    title: "Квиз / игра",
    description: "Интерактив на 1–3 минуты с финалом и мостом в канал.",
  },
  socseti: {
    title: "Соцсети",
    description: "Генератор карточек, таймеров и анонсов под скриншот.",
  },
  styles: {
    title: "Стили",
    description: "6 визуальных приставок — допишите в конец любого промпта.",
  },
};
